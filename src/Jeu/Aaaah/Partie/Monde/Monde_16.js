...
export default class Monde_16 extends MondeAbstrait {
    constructor(jeu) {
        super(jeu);

        this.monde = SM.AaaahSpritesManager.getSprite(SM.Sprites.Monde16);
        this.monde.x = -85;
        this.monde.y = -54.75;
        this.ajouterTexture(this.monde);

        this.M1 = SM.AaaahSpritesManager.getSprite(SM.Sprites.Monde16_M1);
        this.M1.x = 439.5;
        this.M1.y = 196.4;
